...
int compare_ascii(char *, char *);
int sorted_insert(shash_table_t *, shash_node_t *);
int handle_scollision(shash_table_t *, unsigned long int, shash_node_t *);
